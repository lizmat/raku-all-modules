...
is-approx($r1, 0, :abs-tol<1.0>); #delta_within($r1, 0, 1.0);
is-approx($r2, 0, :abs-tol<1.0>); #delta_within($r2, 0, 1.0);
is-approx($r3, 0, :abs-tol<1.0>); #delta_within($r3, 0, 1.0);
is-approx($r4, 0, :abs-tol<1.0>); #delta_within($r4, 0, 1.0);
is-approx($r5, 0, :abs-tol<1.0>); #delta_within($r5, 0, 1.0);
...
is-approx($r1, 313115.736403696, :abs-tol<1.0>); #delta_within($r1, 313115.736403696, 1.0);
is-approx($r2, 313.115736403696, :abs-tol<1.0>); #delta_within($r2, 313.115736403696, 1.0);
is-approx($r3, 194.561098437435, :abs-tol<1.0>); #delta_within($r3, 194.561098437435, 1.0);
is-approx($r4, 1027282.59974966, :abs-tol<1.0>); #delta_within($r4, 1027282.59974966, 1.0);
is-approx($r5, 169.068972140224, :abs-tol<1.0>); #delta_within($r5, 169.068972140224, 1.0);
...
is-approx($r1, 446706.01076052, :abs-tol<1.0>); #delta_within($r1, 446706.01076052, 1.0);
is-approx($r2, 446.70601076052, :abs-tol<1.0>); #delta_within($r2, 446.70601076052, 1.0);
is-approx($r3, 277.570246485848, :abs-tol<1.0>); #delta_within($r3, 277.570246485848, 1.0);
is-approx($r4, 1465570.90144528, :abs-tol<1.0>); #delta_within($r4, 1465570.90144528, 1.0);
is-approx($r5, 241.201949654708, :abs-tol<1.0>); #delta_within($r5, 241.201949654708, 1.0);
...
is-approx($r1, 324047.278966276, :abs-tol<1.0>); #delta_within($r1, 324047.278966276, 1.0);
is-approx($r2, 324.047278966276, :abs-tol<1.0>); #delta_within($r2, 324.047278966276, 1.0);
is-approx($r3, 201.353644072539, :abs-tol<1.0>); #delta_within($r3, 201.353644072539, 1.0);
is-approx($r4, 1063147.240703, :abs-tol<1.0>); #delta_within($r4, 1063147.240703, 1.0);
is-approx($r5, 174.971532919155, :abs-tol<1.0>); #delta_within($r5, 174.971532919155, 1.0);
...
is-approx($r1, 9778578.68718058, :abs-tol<1.0>); #delta_within($r1, 9778578.68718058, 1.0);
is-approx($r2, 9778.57868718058, :abs-tol<1.0>); #delta_within($r2, 9778.57868718058, 1.0);
is-approx($r3, 6076.12709723998, :abs-tol<1.0>); #delta_within($r3, 6076.12709723998, 1.0);
is-approx($r4, 32081951.0734271, :abs-tol<1.0>); #delta_within($r4, 32081951.0734271, 1.0);
is-approx($r5, 5280.01009027029, :abs-tol<1.0>); #delta_within($r5, 5280.01009027029, 1.0);
...
is-approx($r1, 9998088.45002268, :abs-tol<1.0>); #delta_within($r1, 9998088.45002268, 1.0);
is-approx($r2, 9998.08845002268, :abs-tol<1.0>); #delta_within($r2, 9998.08845002268, 1.0);
is-approx($r3, 6212.52414028491, :abs-tol<1.0>); #delta_within($r3, 6212.52414028491, 1.0);
is-approx($r4, 32802127.4607043, :abs-tol<1.0>); #delta_within($r4, 32802127.4607043, 1.0);
is-approx($r5, 5398.53588014184, :abs-tol<1.0>); #delta_within($r5, 5398.53588014184, 1.0);
...
is-approx($r1, 10225216.6599337, :abs-tol<1.0>); #delta_within($r1, 10225216.6599337, 1.0);
is-approx($r2, 10225.2166599337, :abs-tol<1.0>); #delta_within($r2, 10225.2166599337, 1.0);
is-approx($r3, 6353.65506686807, :abs-tol<1.0>); #delta_within($r3, 6353.65506686807, 1.0);
is-approx($r4, 33547298.7530634, :abs-tol<1.0>); #delta_within($r4, 33547298.7530634, 1.0);
is-approx($r5, 5521.17530234002, :abs-tol<1.0>); #delta_within($r5, 5521.17530234002, 1.0);
...
is-approx($r1, 10013675.0566307, :abs-tol<1.0>); #delta_within($r1, 10013675.0566307, 1.0);
is-approx($r2, 10013.6750566307, :abs-tol<1.0>); #delta_within($r2, 10013.6750566307, 1.0);
is-approx($r3, 6222.20920861587, :abs-tol<1.0>); #delta_within($r3, 6222.20920861587, 1.0);
is-approx($r4, 32853264.6214918, :abs-tol<1.0>); #delta_within($r4, 32853264.6214918, 1.0);
is-approx($r5, 5406.95197442262, :abs-tol<1.0>); #delta_within($r5, 5406.95197442262, 1.0);
...
$r4 = $e_foot.range(-88.000000,1.000000,88.000000,1.000000);
$r5 = $e_nm.range(-88.000000,1.000000,88.000000,1.000000);
is-approx($r1, 19557157.3743612, :abs-tol<1.0>); #delta_within($r1, 19557157.3743612, 1.0);
is-approx($r2, 19557.1573743612, :abs-tol<1.0>); #delta_within($r2, 19557.1573743612, 1.0);
is-approx($r3, 12152.25419448, :abs-tol<1.0>); #delta_within($r3, 12152.25419448, 1.0);
is-approx($r4, 64163902.1468542, :abs-tol<1.0>); #delta_within($r4, 64163902.1468542, 1.0);
is-approx($r5, 10560.0201805406, :abs-tol<1.0>); #delta_within($r5, 10560.0201805406, 1.0);
...
$r4 = $e_foot.range(-88.000000,1.000000,88.000000,90.000000);
$r5 = $e_nm.range(-88.000000,1.000000,88.000000,90.000000);
is-approx($r1, 19685321.6740635, :abs-tol<1.0>); #delta_within($r1, 19685321.6740635, 1.0);
is-approx($r2, 19685.3216740635, :abs-tol<1.0>); #delta_within($r2, 19685.3216740635, 1.0);
is-approx($r3, 12231.8917981883, :abs-tol<1.0>); #delta_within($r3, 12231.8917981883, 1.0);
is-approx($r4, 64584388.6944341, :abs-tol<1.0>); #delta_within($r4, 64584388.6944341, 1.0);
is-approx($r5, 10629.223366125, :abs-tol<1.0>); #delta_within($r5, 10629.223366125, 1.0);
...
$r4 = $e_foot.range(-88.000000,1.000000,88.000000,179.000000);
$r5 = $e_nm.range(-88.000000,1.000000,88.000000,179.000000);
is-approx($r1, 19996176.9000454, :abs-tol<1.0>); #delta_within($r1, 19996176.9000454, 1.0);
is-approx($r2, 19996.1769000454, :abs-tol<1.0>); #delta_within($r2, 19996.1769000454, 1.0);
is-approx($r3, 12425.0482805698, :abs-tol<1.0>); #delta_within($r3, 12425.0482805698, 1.0);
is-approx($r4, 65604254.9214087, :abs-tol<1.0>); #delta_within($r4, 65604254.9214087, 1.0);
is-approx($r5, 10797.0717602837, :abs-tol<1.0>); #delta_within($r5, 10797.0717602837, 1.0);
...
$r4 = $e_foot.range(-88.000000,1.000000,88.000000,268.000000);
$r5 = $e_nm.range(-88.000000,1.000000,88.000000,268.000000);
is-approx($r1, 19696447.0104273, :abs-tol<1.0>); #delta_within($r1, 19696447.0104273, 1.0);
is-approx($r2, 19696.4470104273, :abs-tol<1.0>); #delta_within($r2, 19696.4470104273, 1.0);
is-approx($r3, 12238.8047617087, :abs-tol<1.0>); #delta_within($r3, 12238.8047617087, 1.0);
is-approx($r4, 64620889.1418219, :abs-tol<1.0>); #delta_within($r4, 64620889.1418219, 1.0);
is-approx($r5, 10635.2305671854, :abs-tol<1.0>); #delta_within($r5, 10635.2305671854, 1.0);
...
is-approx($r3, 194.561098437435, :abs-tol<1.0>); #delta_within($r3, 194.561098437435, 1.0);
is-approx($r4, 1027282.59974966, :abs-tol<1.0>); #delta_within($r4, 1027282.59974966, 1.0);
is-approx($r5, 169.068972140225, :abs-tol<1.0>); #delta_within($r5, 169.068972140225, 1.0);
...
is-approx($r1, 9907434.68060135, :abs-tol<1.0>); #delta_within($r1, 9907434.68060135, 1.0);
is-approx($r2, 9907.43468060135, :abs-tol<1.0>); #delta_within($r2, 9907.43468060135, 1.0);
is-approx($r3, 6156.19449949877, :abs-tol<1.0>); #delta_within($r3, 6156.19449949877, 1.0);
is-approx($r4, 32504706.9573535, :abs-tol<1.0>); #delta_within($r4, 32504706.9573535, 1.0);
is-approx($r5, 5349.58676058388, :abs-tol<1.0>); #delta_within($r5, 5349.58676058388, 1.0);
...
is-approx($r1, 19814869.3612027, :abs-tol<1.0>); #delta_within($r1, 19814869.3612027, 1.0);
is-approx($r2, 19814.8693612027, :abs-tol<1.0>); #delta_within($r2, 19814.8693612027, 1.0);
is-approx($r3, 12312.3889989975, :abs-tol<1.0>); #delta_within($r3, 12312.3889989975, 1.0);
is-approx($r4, 65009413.914707, :abs-tol<1.0>); #delta_within($r4, 65009413.914707, 1.0);
is-approx($r5, 10699.1735211678, :abs-tol<1.0>); #delta_within($r5, 10699.1735211678, 1.0);
...
is-approx($r1, 10352712.6437744, :abs-tol<1.0>); #delta_within($r1, 10352712.6437744, 1.0);
is-approx($r2, 10352.7126437744, :abs-tol<1.0>); #delta_within($r2, 10352.7126437744, 1.0);
is-approx($r3, 6432.87739835265, :abs-tol<1.0>); #delta_within($r3, 6432.87739835265, 1.0);
is-approx($r4, 33965592.663302, :abs-tol<1.0>); #delta_within($r4, 33965592.663302, 1.0);
is-approx($r5, 5590.0176262281, :abs-tol<1.0>); #delta_within($r5, 5590.0176262281, 1.0);
...
is-approx($r3, 6353.65506686807, :abs-tol<1.0>); #delta_within($r3, 6353.65506686807, 1.0);
is-approx($r4, 33547298.7530634, :abs-tol<1.0>); #delta_within($r4, 33547298.7530634, 1.0);
is-approx($r5, 5521.17530234003, :abs-tol<1.0>); #delta_within($r5, 5521.17530234003, 1.0);
...
$r4 = $e_foot.range(88.000000,1.000000,88.000000,90.000000);
$r5 = $e_nm.range(88.000000,1.000000,88.000000,90.000000);
is-approx($r1, 313115.736403702, :abs-tol<1.0>); #delta_within($r1, 313115.736403702, 1.0);
is-approx($r2, 313.115736403702, :abs-tol<1.0>); #delta_within($r2, 313.115736403702, 1.0);
is-approx($r3, 194.561098437439, :abs-tol<1.0>); #delta_within($r3, 194.561098437439, 1.0);
is-approx($r4, 1027282.59974968, :abs-tol<1.0>); #delta_within($r4, 1027282.59974968, 1.0);
is-approx($r5, 169.068972140228, :abs-tol<1.0>); #delta_within($r5, 169.068972140228, 1.0);
...
$r4 = $e_foot.range(88.000000,1.000000,88.000000,179.000000);
$r5 = $e_nm.range(88.000000,1.000000,88.000000,179.000000);
is-approx($r1, 446706.010760529, :abs-tol<1.0>); #delta_within($r1, 446706.010760529, 1.0);
is-approx($r2, 446.706010760529, :abs-tol<1.0>); #delta_within($r2, 446.706010760529, 1.0);
is-approx($r3, 277.570246485853, :abs-tol<1.0>); #delta_within($r3, 277.570246485853, 1.0);
is-approx($r4, 1465570.9014453, :abs-tol<1.0>); #delta_within($r4, 1465570.9014453, 1.0);
is-approx($r5, 241.201949654713, :abs-tol<1.0>); #delta_within($r5, 241.201949654713, 1.0);
...
$r4 = $e_foot.range(88.000000,1.000000,88.000000,268.000000);
$r5 = $e_nm.range(88.000000,1.000000,88.000000,268.000000);
is-approx($r1, 324047.278966282, :abs-tol<1.0>); #delta_within($r1, 324047.278966282, 1.0);
is-approx($r2, 324.047278966282, :abs-tol<1.0>); #delta_within($r2, 324.047278966282, 1.0);
is-approx($r3, 201.353644072543, :abs-tol<1.0>); #delta_within($r3, 201.353644072543, 1.0);
is-approx($r4, 1063147.24070303, :abs-tol<1.0>); #delta_within($r4, 1063147.24070303, 1.0);
is-approx($r5, 174.971532919159, :abs-tol<1.0>); #delta_within($r5, 174.971532919159, 1.0);
...
is-approx($r1, 2478983.26981422, :abs-tol<1.0>); #delta_within($r1, 2478983.26981422, 1.0);
is-approx($r2, 2478.98326981422, :abs-tol<1.0>); #delta_within($r2, 2478.98326981422, 1.0);
is-approx($r3, 1540.36878990087, :abs-tol<1.0>); #delta_within($r3, 1540.36878990087, 1.0);
is-approx($r4, 8133147.21067658, :abs-tol<1.0>); #delta_within($r4, 8133147.21067658, 1.0);
is-approx($r5, 1338.54388218911, :abs-tol<1.0>); #delta_within($r5, 1338.54388218911, 1.0);
...
is-approx($r1, 13850451.7048934, :abs-tol<1.0>); #delta_within($r1, 13850451.7048934, 1.0);
is-approx($r2, 13850.4517048934, :abs-tol<1.0>); #delta_within($r2, 13850.4517048934, 1.0);
is-approx($r3, 8606.2716888952, :abs-tol<1.0>); #delta_within($r3, 8606.2716888952, 1.0);
is-approx($r4, 45441114.5173666, :abs-tol<1.0>); #delta_within($r4, 45441114.5173666, 1.0);
is-approx($r5, 7478.64562899209, :abs-tol<1.0>); #delta_within($r5, 7478.64562899209, 1.0);
...
is-approx($r1, 13064794.3870629, :abs-tol<1.0>); #delta_within($r1, 13064794.3870629, 1.0);
is-approx($r2, 13064.7943870629, :abs-tol<1.0>); #delta_within($r2, 13064.7943870629, 1.0);
is-approx($r3, 8118.08686462493, :abs-tol<1.0>); #delta_within($r3, 8118.08686462493, 1.0);
is-approx($r4, 42863498.6452196, :abs-tol<1.0>); #delta_within($r4, 42863498.6452196, 1.0);
is-approx($r5, 7054.42461504479, :abs-tol<1.0>); #delta_within($r5, 7054.42461504479, 1.0);
...
is-approx($r1, 17475952.9859877, :abs-tol<1.0>); #delta_within($r1, 17475952.9859877, 1.0);
is-approx($r2, 17475.9529859877, :abs-tol<1.0>); #delta_within($r2, 17475.9529859877, 1.0);
is-approx($r3, 10859.0537423868, :abs-tol<1.0>); #delta_within($r3, 10859.0537423868, 1.0);
is-approx($r4, 57335803.7598023, :abs-tol<1.0>); #delta_within($r4, 57335803.7598023, 1.0);
is-approx($r5, 9436.25971165644, :abs-tol<1.0>); #delta_within($r5, 9436.25971165644, 1.0);
...
is-approx($r1, 9065819.55603936, :abs-tol<1.0>); #delta_within($r1, 9065819.55603936, 1.0);
is-approx($r2, 9065.81955603936, :abs-tol<1.0>); #delta_within($r2, 9065.81955603936, 1.0);
is-approx($r3, 5633.23910614471, :abs-tol<1.0>); #delta_within($r3, 5633.23910614471, 1.0);
is-approx($r4, 29743502.4804441, :abs-tol<1.0>); #delta_within($r4, 29743502.4804441, 1.0);
is-approx($r5, 4895.1509481854, :abs-tol<1.0>); #delta_within($r5, 4895.1509481854, 1.0);
...
is-approx($r1, 11262132.6431769, :abs-tol<1.0>); #delta_within($r1, 11262132.6431769, 1.0);
is-approx($r2, 11262.1326431769, :abs-tol<1.0>); #delta_within($r2, 11262.1326431769, 1.0);
is-approx($r3, 6997.96478762582, :abs-tol<1.0>); #delta_within($r3, 6997.96478762582, 1.0);
is-approx($r4, 36949254.0786643, :abs-tol<1.0>); #delta_within($r4, 36949254.0786643, 1.0);
is-approx($r5, 6081.06514210415, :abs-tol<1.0>); #delta_within($r5, 6081.06514210415, 1.0);
...
is-approx($r1, 8059002.00518262, :abs-tol<1.0>); #delta_within($r1, 8059002.00518262, 1.0);
is-approx($r2, 8059.00200518262, :abs-tol<1.0>); #delta_within($r2, 8059.00200518262, 1.0);
is-approx($r3, 5007.63168420339, :abs-tol<1.0>); #delta_within($r3, 5007.63168420339, 1.0);
is-approx($r4, 26440295.2925939, :abs-tol<1.0>); #delta_within($r4, 26440295.2925939, 1.0);
is-approx($r5, 4351.51296176168, :abs-tol<1.0>); #delta_within($r5, 4351.51296176168, 1.0);
...
is-approx($r1, 13463843.6928142, :abs-tol<1.0>); #delta_within($r1, 13463843.6928142, 1.0);
is-approx($r2, 13463.8436928142, :abs-tol<1.0>); #delta_within($r2, 13463.8436928142, 1.0);
is-approx($r3, 8366.04460750105, :abs-tol<1.0>); #delta_within($r3, 8366.04460750105, 1.0);
is-approx($r4, 44172715.5276056, :abs-tol<1.0>); #delta_within($r4, 44172715.5276056, 1.0);
is-approx($r5, 7269.89400259945, :abs-tol<1.0>); #delta_within($r5, 7269.89400259945, 1.0);
...
is-approx($r1, 14726732.6094757, :abs-tol<1.0>); #delta_within($r1, 14726732.6094757, 1.0);
is-approx($r2, 14726.7326094757, :abs-tol<1.0>); #delta_within($r2, 14726.7326094757, 1.0);
is-approx($r3, 9150.76739931033, :abs-tol<1.0>); #delta_within($r3, 9150.76739931033, 1.0);
is-approx($r4, 48316051.8683585, :abs-tol<1.0>); #delta_within($r4, 48316051.8683585, 1.0);
is-approx($r5, 7951.79946515966, :abs-tol<1.0>); #delta_within($r5, 7951.79946515966, 1.0);
...
is-approx($r1, 6982046.80533501, :abs-tol<1.0>); #delta_within($r1, 6982046.80533501, 1.0);
is-approx($r2, 6982.04680533501, :abs-tol<1.0>); #delta_within($r2, 6982.04680533501, 1.0);
is-approx($r3, 4338.44274768789, :abs-tol<1.0>); #delta_within($r3, 4338.44274768789, 1.0);
is-approx($r4, 22906977.707792, :abs-tol<1.0>); #delta_within($r4, 22906977.707792, 1.0);
is-approx($r5, 3770.00367458694, :abs-tol<1.0>); #delta_within($r5, 3770.00367458694, 1.0);
...
is-approx($r1, 15580306.134578, :abs-tol<1.0>); #delta_within($r1, 15580306.134578, 1.0);
is-approx($r2, 15580.306134578, :abs-tol<1.0>); #delta_within($r2, 15580.306134578, 1.0);
is-approx($r3, 9681.15339826537, :abs-tol<1.0>); #delta_within($r3, 9681.15339826537, 1.0);
is-approx($r4, 51116489.9428412, :abs-tol<1.0>); #delta_within($r4, 51116489.9428412, 1.0);
is-approx($r5, 8412.69229728833, :abs-tol<1.0>); #delta_within($r5, 8412.69229728833, 1.0);
...
is-approx($r1, 4037491.56639158, :abs-tol<1.0>); #delta_within($r1, 4037491.56639158, 1.0);
is-approx($r2, 4037.49156639158, :abs-tol<1.0>); #delta_within($r2, 4037.49156639158, 1.0);
is-approx($r3, 2508.78094825692, :abs-tol<1.0>); #delta_within($r3, 2508.78094825692, 1.0);
is-approx($r4, 13246363.4067965, :abs-tol<1.0>); #delta_within($r4, 13246363.4067965, 1.0);
is-approx($r5, 2180.07104016824, :abs-tol<1.0>); #delta_within($r5, 2180.07104016824, 1.0);
...
is-approx($r1, 5712966.86704551, :abs-tol<1.0>); #delta_within($r1, 5712966.86704551, 1.0);
is-approx($r2, 5712.96686704551, :abs-tol<1.0>); #delta_within($r2, 5712.96686704551, 1.0);
is-approx($r3, 3549.87303338846, :abs-tol<1.0>); #delta_within($r3, 3549.87303338846, 1.0);
is-approx($r4, 18743329.6162911, :abs-tol<1.0>); #delta_within($r4, 18743329.6162911, 1.0);
is-approx($r5, 3084.75532777835, :abs-tol<1.0>); #delta_within($r5, 3084.75532777835, 1.0);
...
is-approx($r1, 9639530.83300946, :abs-tol<1.0>); #delta_within($r1, 9639530.83300946, 1.0);
is-approx($r2, 9639.53083300946, :abs-tol<1.0>); #delta_within($r2, 9639.53083300946, 1.0);
is-approx($r3, 5989.72676631563, :abs-tol<1.0>); #delta_within($r3, 5989.72676631563, 1.0);
is-approx($r4, 31625757.3261465, :abs-tol<1.0>); #delta_within($r4, 31625757.3261465, 1.0);
is-approx($r5, 5204.93025540467, :abs-tol<1.0>); #delta_within($r5, 5204.93025540467, 1.0);
...
is-approx($r1, 2908081.0984665, :abs-tol<1.0>); #delta_within($r1, 2908081.0984665, 1.0);
is-approx($r2, 2908.0810984665, :abs-tol<1.0>); #delta_within($r2, 2908.0810984665, 1.0);
is-approx($r3, 1806.99781927698, :abs-tol<1.0>); #delta_within($r3, 1806.99781927698, 1.0);
is-approx($r4, 9540948.48578247, :abs-tol<1.0>); #delta_within($r4, 9540948.48578247, 1.0);
is-approx($r5, 1570.23817411798, :abs-tol<1.0>); #delta_within($r5, 1570.23817411798, 1.0);
...
is-approx($r1, 10716663.132942, :abs-tol<1.0>); #delta_within($r1, 10716663.132942, 1.0);
is-approx($r2, 10716.663132942, :abs-tol<1.0>); #delta_within($r2, 10716.663132942, 1.0);
is-approx($r3, 6659.02574772207, :abs-tol<1.0>); #delta_within($r3, 6659.02574772207, 1.0);
is-approx($r4, 35159655.9479726, :abs-tol<1.0>); #delta_within($r4, 35159655.9479726, 1.0);
is-approx($r5, 5786.53516897518, :abs-tol<1.0>); #delta_within($r5, 5786.53516897518, 1.0);
...
is-approx($r1, 9642768.3047107, :abs-tol<1.0>); #delta_within($r1, 9642768.3047107, 1.0);
is-approx($r2, 9642.76830471071, :abs-tol<1.0>); #delta_within($r2, 9642.76830471071, 1.0);
is-approx($r3, 5991.73843796647, :abs-tol<1.0>); #delta_within($r3, 5991.73843796647, 1.0);
is-approx($r4, 31636378.9524629, :abs-tol<1.0>); #delta_within($r4, 31636378.9524629, 1.0);
is-approx($r5, 5206.67835027576, :abs-tol<1.0>); #delta_within($r5, 5206.67835027576, 1.0);
...
is-approx($r1, 9331596.49998794, :abs-tol<1.0>); #delta_within($r1, 9331596.49998794, 1.0);
is-approx($r2, 9331.59649998794, :abs-tol<1.0>); #delta_within($r2, 9331.59649998794, 1.0);
is-approx($r3, 5798.38524267524, :abs-tol<1.0>); #delta_within($r3, 5798.38524267524, 1.0);
is-approx($r4, 30615474.0813253, :abs-tol<1.0>); #delta_within($r4, 30615474.0813253, 1.0);
is-approx($r5, 5038.65901727211, :abs-tol<1.0>); #delta_within($r5, 5038.65901727211, 1.0);
...
is-approx($r1, 3334743.62344139, :abs-tol<1.0>); #delta_within($r1, 3334743.62344139, 1.0);
is-approx($r2, 3334.74362344139, :abs-tol<1.0>); #delta_within($r2, 3334.74362344139, 1.0);
is-approx($r3, 2072.11362110362, :abs-tol<1.0>); #delta_within($r3, 2072.11362110362, 1.0);
is-approx($r4, 10940759.9194271, :abs-tol<1.0>); #delta_within($r4, 10940759.9194271, 1.0);
is-approx($r5, 1800.61750725777, :abs-tol<1.0>); #delta_within($r5, 1800.61750725777, 1.0);
...
is-approx($r1, 17966012.0923903, :abs-tol<1.0>); #delta_within($r1, 17966012.0923903, 1.0);
is-approx($r2, 17966.0120923903, :abs-tol<1.0>); #delta_within($r2, 17966.0120923903, 1.0);
is-approx($r3, 11163.5623535989, :abs-tol<1.0>); #delta_within($r3, 11163.5623535989, 1.0);
is-approx($r4, 58943609.2270023, :abs-tol<1.0>); #delta_within($r4, 58943609.2270023, 1.0);
is-approx($r5, 9700.87046025395, :abs-tol<1.0>); #delta_within($r5, 9700.87046025395, 1.0);
...
is-approx($r1, 3925232.39059218, :abs-tol<1.0>); #delta_within($r1, 3925232.39059218, 1.0);
is-approx($r2, 3925.23239059218, :abs-tol<1.0>); #delta_within($r2, 3925.23239059218, 1.0);
is-approx($r3, 2439.02633035086, :abs-tol<1.0>); #delta_within($r3, 2439.02633035086, 1.0);
is-approx($r4, 12878059.0242526, :abs-tol<1.0>); #delta_within($r4, 12878059.0242526, 1.0);
is-approx($r5, 2119.45593444502, :abs-tol<1.0>); #delta_within($r5, 2119.45593444502, 1.0);
...
is-approx($r1, 17193609.7687517, :abs-tol<1.0>); #delta_within($r1, 17193609.7687517, 1.0);
is-approx($r2, 17193.6097687517, :abs-tol<1.0>); #delta_within($r2, 17193.6097687517, 1.0);
is-approx($r3, 10683.6138008727, :abs-tol<1.0>); #delta_within($r3, 10683.6138008727, 1.0);
is-approx($r4, 56409480.868608, :abs-tol<1.0>); #delta_within($r4, 56409480.868608, 1.0);
is-approx($r5, 9283.80657060028, :abs-tol<1.0>); #delta_within($r5, 9283.80657060028, 1.0);
...
is-approx($r1, 7136933.98147936, :abs-tol<1.0>); #delta_within($r1, 7136933.98147936, 1.0);
is-approx($r2, 7136.93398147936, :abs-tol<1.0>); #delta_within($r2, 7136.93398147936, 1.0);
is-approx($r3, 4434.68517699097, :abs-tol<1.0>); #delta_within($r3, 4434.68517699097, 1.0);
is-approx($r4, 23415137.7345123, :abs-tol<1.0>); #delta_within($r4, 23415137.7345123, 1.0);
is-approx($r5, 3853.63605911413, :abs-tol<1.0>); #delta_within($r5, 3853.63605911413, 1.0);
...
is-approx($r1, 6104433.98020838, :abs-tol<1.0>); #delta_within($r1, 6104433.98020838, 1.0);
is-approx($r2, 6104.43398020838, :abs-tol<1.0>); #delta_within($r2, 6104.43398020838, 1.0);
is-approx($r3, 3793.11942021617, :abs-tol<1.0>); #delta_within($r3, 3793.11942021617, 1.0);
is-approx($r4, 20027670.5387414, :abs-tol<1.0>); #delta_within($r4, 20027670.5387414, 1.0);
is-approx($r5, 3296.13065885982, :abs-tol<1.0>); #delta_within($r5, 3296.13065885982, 1.0);
...
is-approx($r1, 15067414.5790259, :abs-tol<1.0>); #delta_within($r1, 15067414.5790259, 1.0);
is-approx($r2, 15067.4145790259, :abs-tol<1.0>); #delta_within($r2, 15067.4145790259, 1.0);
is-approx($r3, 9362.45736090351, :abs-tol<1.0>); #delta_within($r3, 9362.45736090351, 1.0);
is-approx($r4, 49433774.8655706, :abs-tol<1.0>); #delta_within($r4, 49433774.8655706, 1.0);
is-approx($r5, 8135.75301243299, :abs-tol<1.0>); #delta_within($r5, 8135.75301243299, 1.0);
...
is-approx($r1, 8006275.94631107, :abs-tol<1.0>); #delta_within($r1, 8006275.94631107, 1.0);
is-approx($r2, 8006.27594631107, :abs-tol<1.0>); #delta_within($r2, 8006.27594631107, 1.0);
is-approx($r3, 4974.8692301404, :abs-tol<1.0>); #delta_within($r3, 4974.8692301404, 1.0);
is-approx($r4, 26267309.5351413, :abs-tol<1.0>); #delta_within($r4, 26267309.5351413, 1.0);
is-approx($r5, 4323.04316755457, :abs-tol<1.0>); #delta_within($r5, 4323.04316755457, 1.0);
...
is-approx($r1, 5452116.89026308, :abs-tol<1.0>); #delta_within($r1, 5452116.89026308, 1.0);
is-approx($r2, 5452.11689026308, :abs-tol<1.0>); #delta_within($r2, 5452.11689026308, 1.0);
is-approx($r3, 3387.78837232007, :abs-tol<1.0>); #delta_within($r3, 3387.78837232007, 1.0);
is-approx($r4, 17887522.60585, :abs-tol<1.0>); #delta_within($r4, 17887522.60585, 1.0);
is-approx($r5, 2943.90760813341, :abs-tol<1.0>); #delta_within($r5, 2943.90760813341, 1.0);
...
is-approx($r1, 17744632.7153385, :abs-tol<1.0>); #delta_within($r1, 17744632.7153385, 1.0);
is-approx($r2, 17744.6327153385, :abs-tol<1.0>); #delta_within($r2, 17744.6327153385, 1.0);
is-approx($r3, 11026.0035861435, :abs-tol<1.0>); #delta_within($r3, 11026.0035861435, 1.0);
is-approx($r4, 58217298.9348376, :abs-tol<1.0>); #delta_within($r4, 58217298.9348376, 1.0);
is-approx($r5, 9581.33515947003, :abs-tol<1.0>); #delta_within($r5, 9581.33515947003, 1.0);
...
is-approx($r1, 11405061.5799716, :abs-tol<1.0>); #delta_within($r1, 11405061.5799716, 1.0);
is-approx($r2, 11405.0615799716, :abs-tol<1.0>); #delta_within($r2, 11405.0615799716, 1.0);
is-approx($r3, 7086.77671148718, :abs-tol<1.0>); #delta_within($r3, 7086.77671148718, 1.0);
is-approx($r4, 37418181.0366523, :abs-tol<1.0>); #delta_within($r4, 37418181.0366523, 1.0);
is-approx($r5, 6158.24059393716, :abs-tol<1.0>); #delta_within($r5, 6158.24059393716, 1.0);
...
is-approx($r1, 13771611.4326195, :abs-tol<1.0>); #delta_within($r1, 13771611.4326195, 1.0);
is-approx($r2, 13771.6114326195, :abs-tol<1.0>); #delta_within($r2, 13771.6114326195, 1.0);
is-approx($r3, 8557.28261491609, :abs-tol<1.0>); #delta_within($r3, 8557.28261491609, 1.0);
is-approx($r4, 45182452.2067569, :abs-tol<1.0>); #delta_within($r4, 45182452.2067569, 1.0);
is-approx($r5, 7436.07528759153, :abs-tol<1.0>); #delta_within($r5, 7436.07528759153, 1.0);
...
is-approx($r1, 16984526.9730499, :abs-tol<1.0>); #delta_within($r1, 16984526.9730499, 1.0);
is-approx($r2, 16984.5269730499, :abs-tol<1.0>); #delta_within($r2, 16984.5269730499, 1.0);
is-approx($r3, 10553.6957748312, :abs-tol<1.0>); #delta_within($r3, 10553.6957748312, 1.0);
is-approx($r4, 55723513.6911087, :abs-tol<1.0>); #delta_within($r4, 55723513.6911087, 1.0);
is-approx($r5, 9170.91089257556, :abs-tol<1.0>); #delta_within($r5, 9170.91089257556, 1.0);
...
is-approx($r1, 9970926.02740749, :abs-tol<1.0>); #delta_within($r1, 9970926.02740749, 1.0);
is-approx($r2, 9970.92602740749, :abs-tol<1.0>); #delta_within($r2, 9970.92602740749, 1.0);
is-approx($r3, 6195.64619336046, :abs-tol<1.0>); #delta_within($r3, 6195.64619336046, 1.0);
is-approx($r4, 32713011.9009432, :abs-tol<1.0>); #delta_within($r4, 32713011.9009432, 1.0);
is-approx($r5, 5383.86934525243, :abs-tol<1.0>); #delta_within($r5, 5383.86934525243, 1.0);
...
is-approx($r1, 9733041.79438803, :abs-tol<1.0>); #delta_within($r1, 9733041.79438803, 1.0);
is-approx($r2, 9733.04179438803, :abs-tol<1.0>); #delta_within($r2, 9733.04179438803, 1.0);
is-approx($r3, 6047.83178387469, :abs-tol<1.0>); #delta_within($r3, 6047.83178387469, 1.0);
is-approx($r4, 31932551.8188584, :abs-tol<1.0>); #delta_within($r4, 31932551.8188584, 1.0);
is-approx($r5, 5255.42213519872, :abs-tol<1.0>); #delta_within($r5, 5255.42213519872, 1.0);
...
is-approx($r1, 3887427.27158255, :abs-tol<1.0>); #delta_within($r1, 3887427.27158255, 1.0);
is-approx($r2, 3887.42727158255, :abs-tol<1.0>); #delta_within($r2, 3887.42727158255, 1.0);
is-approx($r3, 2415.53531847917, :abs-tol<1.0>); #delta_within($r3, 2415.53531847917, 1.0);
is-approx($r4, 12754026.48157, :abs-tol<1.0>); #delta_within($r4, 12754026.48157, 1.0);
is-approx($r5, 2099.04280323032, :abs-tol<1.0>); #delta_within($r5, 2099.04280323032, 1.0);
...
is-approx($r1, 11188758.804159, :abs-tol<1.0>); #delta_within($r1, 11188758.804159, 1.0);
is-approx($r2, 11188.758804159, :abs-tol<1.0>); #delta_within($r2, 11188.758804159, 1.0);
is-approx($r3, 6952.37239779623, :abs-tol<1.0>); #delta_within($r3, 6952.37239779623, 1.0);
is-approx($r4, 36708526.2603641, :abs-tol<1.0>); #delta_within($r4, 36708526.2603641, 1.0);
is-approx($r5, 6041.44643853077, :abs-tol<1.0>); #delta_within($r5, 6041.44643853077, 1.0);
...
is-approx($r1, 9223027.54994791, :abs-tol<1.0>); #delta_within($r1, 9223027.54994791, 1.0);
is-approx($r2, 9223.02754994791, :abs-tol<1.0>); #delta_within($r2, 9223.02754994791, 1.0);
is-approx($r3, 5730.92362474891, :abs-tol<1.0>); #delta_within($r3, 5730.92362474891, 1.0);
is-approx($r4, 30259276.7386742, :abs-tol<1.0>); #delta_within($r4, 30259276.7386742, 1.0);
is-approx($r5, 4980.03647405395, :abs-tol<1.0>); #delta_within($r5, 4980.03647405395, 1.0);
...
is-approx($r1, 6331138.72714117, :abs-tol<1.0>); #delta_within($r1, 6331138.72714117, 1.0);
is-approx($r2, 6331.13872714117, :abs-tol<1.0>); #delta_within($r2, 6331.13872714117, 1.0);
is-approx($r3, 3933.98721910367, :abs-tol<1.0>); #delta_within($r3, 3933.98721910367, 1.0);
is-approx($r4, 20771452.5168674, :abs-tol<1.0>); #delta_within($r4, 20771452.5168674, 1.0);
is-approx($r5, 3418.54142934189, :abs-tol<1.0>); #delta_within($r5, 3418.54142934189, 1.0);
...
is-approx($r1, 10606793.2549714, :abs-tol<1.0>); #delta_within($r1, 10606793.2549714, 1.0);
is-approx($r2, 10606.7932549714, :abs-tol<1.0>); #delta_within($r2, 10606.7932549714, 1.0);
is-approx($r3, 6590.75577065649, :abs-tol<1.0>); #delta_within($r3, 6590.75577065649, 1.0);
is-approx($r4, 34799190.4690663, :abs-tol<1.0>); #delta_within($r4, 34799190.4690663, 1.0);
is-approx($r5, 5727.21018087009, :abs-tol<1.0>); #delta_within($r5, 5727.21018087009, 1.0);
...
is-approx($r1, 3807870.32524918, :abs-tol<1.0>); #delta_within($r1, 3807870.32524918, 1.0);
is-approx($r2, 3807.87032524918, :abs-tol<1.0>); #delta_within($r2, 3807.87032524918, 1.0);
is-approx($r3, 2366.10092388525, :abs-tol<1.0>); #delta_within($r3, 2366.10092388525, 1.0);
is-approx($r4, 12493012.8781141, :abs-tol<1.0>); #delta_within($r4, 12493012.8781141, 1.0);
is-approx($r5, 2056.08548879545, :abs-tol<1.0>); #delta_within($r5, 2056.08548879545, 1.0);
...
is-approx($r1, 6929484.96260079, :abs-tol<1.0>); #delta_within($r1, 6929484.96260079, 1.0);
is-approx($r2, 6929.48496260079, :abs-tol<1.0>); #delta_within($r2, 6929.48496260079, 1.0);
is-approx($r3, 4305.78233280193, :abs-tol<1.0>); #delta_within($r3, 4305.78233280193, 1.0);
is-approx($r4, 22734530.7171942, :abs-tol<1.0>); #delta_within($r4, 22734530.7171942, 1.0);
is-approx($r5, 3741.62255000043, :abs-tol<1.0>); #delta_within($r5, 3741.62255000043, 1.0);
...
is-approx($r1, 14344572.4591005, :abs-tol<1.0>); #delta_within($r1, 14344572.4591005, 1.0);
is-approx($r2, 14344.5724591005, :abs-tol<1.0>); #delta_within($r2, 14344.5724591005, 1.0);
is-approx($r3, 8913.30409104613, :abs-tol<1.0>); #delta_within($r3, 8913.30409104613, 1.0);
is-approx($r4, 47062245.6007236, :abs-tol<1.0>); #delta_within($r4, 47062245.6007236, 1.0);
is-approx($r5, 7745.44949195494, :abs-tol<1.0>); #delta_within($r5, 7745.44949195494, 1.0);
...
is-approx($r1, 12142365.0295713, :abs-tol<1.0>); #delta_within($r1, 12142365.0295713, 1.0);
is-approx($r2, 12142.3650295713, :abs-tol<1.0>); #delta_within($r2, 12142.3650295713, 1.0);
is-approx($r3, 7544.91583500565, :abs-tol<1.0>); #delta_within($r3, 7544.91583500565, 1.0);
is-approx($r4, 39837155.6088298, :abs-tol<1.0>); #delta_within($r4, 39837155.6088298, 1.0);
is-approx($r5, 6556.3526077599, :abs-tol<1.0>); #delta_within($r5, 6556.3526077599, 1.0);
...
is-approx($r1, 12743611.5768642, :abs-tol<1.0>); #delta_within($r1, 12743611.5768642, 1.0);
is-approx($r2, 12743.6115768642, :abs-tol<1.0>); #delta_within($r2, 12743.6115768642, 1.0);
is-approx($r3, 7918.51311892559, :abs-tol<1.0>); #delta_within($r3, 7918.51311892559, 1.0);
is-approx($r4, 41809749.2679271, :abs-tol<1.0>); #delta_within($r4, 41809749.2679271, 1.0);
is-approx($r5, 6880.99977152493, :abs-tol<1.0>); #delta_within($r5, 6880.99977152493, 1.0);
...
is-approx($r1, 10640434.6234949, :abs-tol<1.0>); #delta_within($r1, 10640434.6234949, 1.0);
is-approx($r2, 10640.4346234949, :abs-tol<1.0>); #delta_within($r2, 10640.4346234949, 1.0);
is-approx($r3, 6611.65954792444, :abs-tol<1.0>); #delta_within($r3, 6611.65954792444, 1.0);
is-approx($r4, 34909562.413041, :abs-tol<1.0>); #delta_within($r4, 34909562.413041, 1.0);
is-approx($r5, 5745.37506668192, :abs-tol<1.0>); #delta_within($r5, 5745.37506668192, 1.0);
...
is-approx($r1, 6973908.49631601, :abs-tol<1.0>); #delta_within($r1, 6973908.49631601, 1.0);
is-approx($r2, 6973.90849631601, :abs-tol<1.0>); #delta_within($r2, 6973.90849631601, 1.0);
is-approx($r3, 4333.38583690995, :abs-tol<1.0>); #delta_within($r3, 4333.38583690995, 1.0);
is-approx($r4, 22880277.2188845, :abs-tol<1.0>); #delta_within($r4, 22880277.2188845, 1.0);
is-approx($r5, 3765.6093392635, :abs-tol<1.0>); #delta_within($r5, 3765.6093392635, 1.0);
...
is-approx($r1, 9674590.63953447, :abs-tol<1.0>); #delta_within($r1, 9674590.63953447, 1.0);
is-approx($r2, 9674.59063953447, :abs-tol<1.0>); #delta_within($r2, 9674.59063953447, 1.0);
is-approx($r3, 6011.51192009568, :abs-tol<1.0>); #delta_within($r3, 6011.51192009568, 1.0);
is-approx($r4, 31740782.9381052, :abs-tol<1.0>); #delta_within($r4, 31740782.9381052, 1.0);
is-approx($r5, 5223.86103646569, :abs-tol<1.0>); #delta_within($r5, 5223.86103646569, 1.0);
...
is-approx($r1, 10265664.1927237, :abs-tol<1.0>); #delta_within($r1, 10265664.1927237, 1.0);
is-approx($r2, 10265.6641927237, :abs-tol<1.0>); #delta_within($r2, 10265.6641927237, 1.0);
is-approx($r3, 6378.78799854086, :abs-tol<1.0>); #delta_within($r3, 6378.78799854086, 1.0);
is-approx($r4, 33680000.6322957, :abs-tol<1.0>); #delta_within($r4, 33680000.6322957, 1.0);
is-approx($r5, 5543.01522285299, :abs-tol<1.0>); #delta_within($r5, 5543.01522285299, 1.0);
...
is-approx($r1, 1388279.96503049, :abs-tol<1.0>); #delta_within($r1, 1388279.96503049, 1.0);
is-approx($r2, 1388.27996503049, :abs-tol<1.0>); #delta_within($r2, 1388.27996503049, 1.0);
is-approx($r3, 862.637177030198, :abs-tol<1.0>); #delta_within($r3, 862.637177030198, 1.0);
is-approx($r4, 4554724.29471945, :abs-tol<1.0>); #delta_within($r4, 4554724.29471945, 1.0);
is-approx($r5, 749.611212219486, :abs-tol<1.0>); #delta_within($r5, 749.611212219486, 1.0);
...
is-approx($r1, 3642825.04801401, :abs-tol<1.0>); #delta_within($r1, 3642825.04801401, 1.0);
is-approx($r2, 3642.82504801401, :abs-tol<1.0>); #delta_within($r2, 3642.82504801401, 1.0);
is-approx($r3, 2263.54654319649, :abs-tol<1.0>); #delta_within($r3, 2263.54654319649, 1.0);
is-approx($r4, 11951525.7480774, :abs-tol<1.0>); #delta_within($r4, 11951525.7480774, 1.0);
is-approx($r5, 1966.96816847408, :abs-tol<1.0>); #delta_within($r5, 1966.96816847408, 1.0);
...
is-approx($r1, 5012011.5716539, :abs-tol<1.0>); #delta_within($r1, 5012011.5716539, 1.0);
is-approx($r2, 5012.0115716539, :abs-tol<1.0>); #delta_within($r2, 5012.0115716539, 1.0);
is-approx($r3, 3114.3196057859, :abs-tol<1.0>); #delta_within($r3, 3114.3196057859, 1.0);
is-approx($r4, 16443607.5185495, :abs-tol<1.0>); #delta_within($r4, 16443607.5185495, 1.0);
is-approx($r5, 2706.26974711334, :abs-tol<1.0>); #delta_within($r5, 2706.26974711334, 1.0);
...
is-approx($r1, 11650461.6034958, :abs-tol<1.0>); #delta_within($r1, 11650461.6034958, 1.0);
is-approx($r2, 11650.4616034958, :abs-tol<1.0>); #delta_within($r2, 11650.4616034958, 1.0);
is-approx($r3, 7239.26121667946, :abs-tol<1.0>); #delta_within($r3, 7239.26121667946, 1.0);
is-approx($r4, 38223299.2240676, :abs-tol<1.0>); #delta_within($r4, 38223299.2240676, 1.0);
is-approx($r5, 6290.74600620723, :abs-tol<1.0>); #delta_within($r5, 6290.74600620723, 1.0);
...
is-approx($r1, 6017359.40295353, :abs-tol<1.0>); #delta_within($r1, 6017359.40295353, 1.0);
is-approx($r2, 6017.35940295353, :abs-tol<1.0>); #delta_within($r2, 6017.35940295353, 1.0);
is-approx($r3, 3739.01378633377, :abs-tol<1.0>); #delta_within($r3, 3739.01378633377, 1.0);
is-approx($r4, 19741992.7918423, :abs-tol<1.0>); #delta_within($r4, 19741992.7918423, 1.0);
is-approx($r5, 3249.11414846303, :abs-tol<1.0>); #delta_within($r5, 3249.11414846303, 1.0);
...
is-approx($r1, 4923654.59463329, :abs-tol<1.0>); #delta_within($r1, 4923654.59463329, 1.0);
is-approx($r2, 4923.65459463329, :abs-tol<1.0>); #delta_within($r2, 4923.65459463329, 1.0);
is-approx($r3, 3059.41712563211, :abs-tol<1.0>); #delta_within($r3, 3059.41712563211, 1.0);
is-approx($r4, 16153722.4233376, :abs-tol<1.0>); #delta_within($r4, 16153722.4233376, 1.0);
is-approx($r5, 2658.56079623828, :abs-tol<1.0>); #delta_within($r5, 2658.56079623828, 1.0);
...
is-approx($r1, 1743562.46751605, :abs-tol<1.0>); #delta_within($r1, 1743562.46751605, 1.0);
is-approx($r2, 1743.56246751605, :abs-tol<1.0>); #delta_within($r2, 1743.56246751605, 1.0);
is-approx($r3, 1083.39948918072, :abs-tol<1.0>); #delta_within($r3, 1083.39948918072, 1.0);
is-approx($r4, 5720349.30287419, :abs-tol<1.0>); #delta_within($r4, 5720349.30287419, 1.0);
is-approx($r5, 941.448416585341, :abs-tol<1.0>); #delta_within($r5, 941.448416585341, 1.0);
...
is-approx($r1, 7005716.26957978, :abs-tol<1.0>); #delta_within($r1, 7005716.26957978, 1.0);
is-approx($r2, 7005.71626957978, :abs-tol<1.0>); #delta_within($r2, 7005.71626957978, 1.0);
is-approx($r3, 4353.15027090528, :abs-tol<1.0>); #delta_within($r3, 4353.15027090528, 1.0);
is-approx($r4, 22984633.4303799, :abs-tol<1.0>); #delta_within($r4, 22984633.4303799, 1.0);
is-approx($r5, 3782.78416284005, :abs-tol<1.0>); #delta_within($r5, 3782.78416284005, 1.0);
...
is-approx($r1, 4215876.49472136, :abs-tol<1.0>); #delta_within($r1, 4215876.49472136, 1.0);
is-approx($r2, 4215.87649472136, :abs-tol<1.0>); #delta_within($r2, 4215.87649472136, 1.0);
is-approx($r3, 2619.62420385037, :abs-tol<1.0>); #delta_within($r3, 2619.62420385037, 1.0);
is-approx($r4, 13831615.7963299, :abs-tol<1.0>); #delta_within($r4, 13831615.7963299, 1.0);
is-approx($r5, 2276.39119585387, :abs-tol<1.0>); #delta_within($r5, 2276.39119585387, 1.0);
...
is-approx($r1, 18415518.434645, :abs-tol<1.0>); #delta_within($r1, 18415518.434645, 1.0);
is-approx($r2, 18415.518434645, :abs-tol<1.0>); #delta_within($r2, 18415.518434645, 1.0);
is-approx($r3, 11442.872645404, :abs-tol<1.0>); #delta_within($r3, 11442.872645404, 1.0);
is-approx($r4, 60418367.5677329, :abs-tol<1.0>); #delta_within($r4, 60418367.5677329, 1.0);
is-approx($r5, 9943.58446795085, :abs-tol<1.0>); #delta_within($r5, 9943.58446795085, 1.0);
...
is-approx($r1, 14421564.897997, :abs-tol<1.0>); #delta_within($r1, 14421564.897997, 1.0);
is-approx($r2, 14421.564897997, :abs-tol<1.0>); #delta_within($r2, 14421.564897997, 1.0);
is-approx($r3, 8961.14497459645, :abs-tol<1.0>); #delta_within($r3, 8961.14497459645, 1.0);
is-approx($r4, 47314845.4658693, :abs-tol<1.0>); #delta_within($r4, 47314845.4658693, 1.0);
is-approx($r5, 7787.02208315171, :abs-tol<1.0>); #delta_within($r5, 7787.02208315171, 1.0);
...
is-approx($r1, 9055964.88324431, :abs-tol<1.0>); #delta_within($r1, 9055964.88324431, 1.0);
is-approx($r2, 9055.96488324431, :abs-tol<1.0>); #delta_within($r2, 9055.96488324431, 1.0);
is-approx($r3, 5627.11569636095, :abs-tol<1.0>); #delta_within($r3, 5627.11569636095, 1.0);
is-approx($r4, 29711170.8767858, :abs-tol<1.0>); #delta_within($r4, 29711170.8767858, 1.0);
is-approx($r5, 4889.82985056388, :abs-tol<1.0>); #delta_within($r5, 4889.82985056388, 1.0);
...
is-approx($r1, 7978668.24478752, :abs-tol<1.0>); #delta_within($r1, 7978668.24478752, 1.0);
is-approx($r2, 7978.66824478752, :abs-tol<1.0>); #delta_within($r2, 7978.66824478752, 1.0);
is-approx($r3, 4957.71459972978, :abs-tol<1.0>); #delta_within($r3, 4957.71459972978, 1.0);
is-approx($r4, 26176733.0865732, :abs-tol<1.0>); #delta_within($r4, 26176733.0865732, 1.0);
is-approx($r5, 4308.13620128916, :abs-tol<1.0>); #delta_within($r5, 4308.13620128916, 1.0);
...
is-approx($r1, 5522070.40672904, :abs-tol<1.0>); #delta_within($r1, 5522070.40672904, 1.0);
is-approx($r2, 5522.07040672904, :abs-tol<1.0>); #delta_within($r2, 5522.07040672904, 1.0);
is-approx($r3, 3431.25547224772, :abs-tol<1.0>); #delta_within($r3, 3431.25547224772, 1.0);
is-approx($r4, 18117028.893468, :abs-tol<1.0>); #delta_within($r4, 18117028.893468, 1.0);
is-approx($r5, 2981.67948527486, :abs-tol<1.0>); #delta_within($r5, 2981.67948527486, 1.0);
...
is-approx($r1, 2664806.26132369, :abs-tol<1.0>); #delta_within($r1, 2664806.26132369, 1.0);
is-approx($r2, 2664.80626132369, :abs-tol<1.0>); #delta_within($r2, 2664.80626132369, 1.0);
is-approx($r3, 1655.83384368022, :abs-tol<1.0>); #delta_within($r3, 1655.83384368022, 1.0);
is-approx($r4, 8742802.69463154, :abs-tol<1.0>); #delta_within($r4, 8742802.69463154, 1.0);
is-approx($r5, 1438.88027069314, :abs-tol<1.0>); #delta_within($r5, 1438.88027069314, 1.0);
...
is-approx($r1, 11054300.8320442, :abs-tol<1.0>); #delta_within($r1, 11054300.8320442, 1.0);
is-approx($r2, 11054.3008320442, :abs-tol<1.0>); #delta_within($r2, 11054.3008320442, 1.0);
is-approx($r3, 6868.82408735747, :abs-tol<1.0>); #delta_within($r3, 6868.82408735747, 1.0);
is-approx($r4, 36267391.1812474, :abs-tol<1.0>); #delta_within($r4, 36267391.1812474, 1.0);
is-approx($r5, 5968.84494170854, :abs-tol<1.0>); #delta_within($r5, 5968.84494170854, 1.0);
...
is-approx($r1, 11523412.006604, :abs-tol<1.0>); #delta_within($r1, 11523412.006604, 1.0);
is-approx($r2, 11523.412006604, :abs-tol<1.0>); #delta_within($r2, 11523.412006604, 1.0);
is-approx($r3, 7160.31625718551, :abs-tol<1.0>); #delta_within($r3, 7160.31625718551, 1.0);
is-approx($r4, 37806469.8379395, :abs-tol<1.0>); #delta_within($r4, 37806469.8379395, 1.0);
is-approx($r5, 6222.14471198918, :abs-tol<1.0>); #delta_within($r5, 6222.14471198918, 1.0);
...
is-approx($r1, 18046314.1453549, :abs-tol<1.0>); #delta_within($r1, 18046314.1453549, 1.0);
is-approx($r2, 18046.3141453549, :abs-tol<1.0>); #delta_within($r2, 18046.3141453549, 1.0);
is-approx($r3, 11213.4597359886, :abs-tol<1.0>); #delta_within($r3, 11213.4597359886, 1.0);
is-approx($r4, 59207067.4060199, :abs-tol<1.0>); #delta_within($r4, 59207067.4060199, 1.0);
is-approx($r5, 9744.23010008363, :abs-tol<1.0>); #delta_within($r5, 9744.23010008363, 1.0);
...
is-approx($r1, 7840004.49282381, :abs-tol<1.0>); #delta_within($r1, 7840004.49282381, 1.0);
is-approx($r2, 7840.00449282381, :abs-tol<1.0>); #delta_within($r2, 7840.00449282381, 1.0);
is-approx($r3, 4871.55293885198, :abs-tol<1.0>); #delta_within($r3, 4871.55293885198, 1.0);
is-approx($r4, 25721799.5171385, :abs-tol<1.0>); #delta_within($r4, 25721799.5171385, 1.0);
is-approx($r5, 4233.26376502365, :abs-tol<1.0>); #delta_within($r5, 4233.26376502365, 1.0);
...
is-approx($r1, 13175801.2840537, :abs-tol<1.0>); #delta_within($r1, 13175801.2840537, 1.0);
is-approx($r2, 13175.8012840537, :abs-tol<1.0>); #delta_within($r2, 13175.8012840537, 1.0);
is-approx($r3, 8187.06335255465, :abs-tol<1.0>); #delta_within($r3, 8187.06335255465, 1.0);
is-approx($r4, 43227694.5014886, :abs-tol<1.0>); #delta_within($r4, 43227694.5014886, 1.0);
is-approx($r5, 7114.36354430546, :abs-tol<1.0>); #delta_within($r5, 7114.36354430546, 1.0);
...
is-approx($r1, 14563419.7032954, :abs-tol<1.0>); #delta_within($r1, 14563419.7032954, 1.0);
is-approx($r2, 14563.4197032954, :abs-tol<1.0>); #delta_within($r2, 14563.4197032954, 1.0);
is-approx($r3, 9049.28946408937, :abs-tol<1.0>); #delta_within($r3, 9049.28946408937, 1.0);
is-approx($r4, 47780248.3703919, :abs-tol<1.0>); #delta_within($r4, 47780248.3703919, 1.0);
is-approx($r5, 7863.61755037551, :abs-tol<1.0>); #delta_within($r5, 7863.61755037551, 1.0);
...
is-approx($r1, 13409094.6209134, :abs-tol<1.0>); #delta_within($r1, 13409094.6209134, 1.0);
is-approx($r2, 13409.0946209134, :abs-tol<1.0>); #delta_within($r2, 13409.0946209134, 1.0);
is-approx($r3, 8332.02511142016, :abs-tol<1.0>); #delta_within($r3, 8332.02511142016, 1.0);
is-approx($r4, 43993092.5882985, :abs-tol<1.0>); #delta_within($r4, 43993092.5882985, 1.0);
is-approx($r5, 7240.33186874372, :abs-tol<1.0>); #delta_within($r5, 7240.33186874372, 1.0);
...
is-approx($r1, 8019595.70546293, :abs-tol<1.0>); #delta_within($r1, 8019595.70546293, 1.0);
is-approx($r2, 8019.59570546293, :abs-tol<1.0>); #delta_within($r2, 8019.59570546293, 1.0);
is-approx($r3, 4983.14574476491, :abs-tol<1.0>); #delta_within($r3, 4983.14574476491, 1.0);
is-approx($r4, 26311009.5323587, :abs-tol<1.0>); #delta_within($r4, 26311009.5323587, 1.0);
is-approx($r5, 4330.23526212901, :abs-tol<1.0>); #delta_within($r5, 4330.23526212901, 1.0);
...
is-approx($r1, 1585126.11176859, :abs-tol<1.0>); #delta_within($r1, 1585126.11176859, 1.0);
is-approx($r2, 1585.12611176859, :abs-tol<1.0>); #delta_within($r2, 1585.12611176859, 1.0);
is-approx($r3, 984.951701916177, :abs-tol<1.0>); #delta_within($r3, 984.951701916177, 1.0);
is-approx($r4, 5200544.98611741, :abs-tol<1.0>); #delta_within($r4, 5200544.98611741, 1.0);
is-approx($r5, 855.899628384767, :abs-tol<1.0>); #delta_within($r5, 855.899628384767, 1.0);
...
is-approx($r1, 17322878.3638282, :abs-tol<1.0>); #delta_within($r1, 17322878.3638282, 1.0);
is-approx($r2, 17322.8783638282, :abs-tol<1.0>); #delta_within($r2, 17322.8783638282, 1.0);
is-approx($r3, 10763.9375819142, :abs-tol<1.0>); #delta_within($r3, 10763.9375819142, 1.0);
is-approx($r4, 56833590.4325071, :abs-tol<1.0>); #delta_within($r4, 56833590.4325071, 1.0);
is-approx($r5, 9353.60602798496, :abs-tol<1.0>); #delta_within($r5, 9353.60602798496, 1.0);
...
is-approx($r1, 1546932.16434011, :abs-tol<1.0>); #delta_within($r1, 1546932.16434011, 1.0);
is-approx($r2, 1546.93216434011, :abs-tol<1.0>); #delta_within($r2, 1546.93216434011, 1.0);
is-approx($r3, 961.219083266293, :abs-tol<1.0>); #delta_within($r3, 961.219083266293, 1.0);
is-approx($r4, 5075236.75964603, :abs-tol<1.0>); #delta_within($r4, 5075236.75964603, 1.0);
is-approx($r5, 835.276546619929, :abs-tol<1.0>); #delta_within($r5, 835.276546619929, 1.0);
...
is-approx($r1, 10591953.1790129, :abs-tol<1.0>); #delta_within($r1, 10591953.1790129, 1.0);
is-approx($r2, 10591.9531790129, :abs-tol<1.0>); #delta_within($r2, 10591.9531790129, 1.0);
is-approx($r3, 6581.53457496525, :abs-tol<1.0>); #delta_within($r3, 6581.53457496525, 1.0);
is-approx($r4, 34750502.5558165, :abs-tol<1.0>); #delta_within($r4, 34750502.5558165, 1.0);
is-approx($r5, 5719.19718089248, :abs-tol<1.0>); #delta_within($r5, 5719.19718089248, 1.0);
...
is-approx($r1, 13006113.218666, :abs-tol<1.0>); #delta_within($r1, 13006113.218666, 1.0);
is-approx($r2, 13006.113218666, :abs-tol<1.0>); #delta_within($r2, 13006.113218666, 1.0);
is-approx($r3, 8081.62407705625, :abs-tol<1.0>); #delta_within($r3, 8081.62407705625, 1.0);
is-approx($r4, 42670975.126857, :abs-tol<1.0>); #delta_within($r4, 42670975.126857, 1.0);
is-approx($r5, 7022.73931893413, :abs-tol<1.0>); #delta_within($r5, 7022.73931893413, 1.0);
...
is-approx($r1, 676004.612711586, :abs-tol<1.0>); #delta_within($r1, 676004.612711586, 1.0);
is-approx($r2, 676.004612711586, :abs-tol<1.0>); #delta_within($r2, 676.004612711586, 1.0);
is-approx($r3, 420.049792158535, :abs-tol<1.0>); #delta_within($r3, 420.049792158535, 1.0);
is-approx($r4, 2217862.90259707, :abs-tol<1.0>); #delta_within($r4, 2217862.90259707, 1.0);
is-approx($r5, 365.013289801072, :abs-tol<1.0>); #delta_within($r5, 365.013289801072, 1.0);
...
is-approx($r1, 13769363.5529944, :abs-tol<1.0>); #delta_within($r1, 13769363.5529944, 1.0);
is-approx($r2, 13769.3635529944, :abs-tol<1.0>); #delta_within($r2, 13769.3635529944, 1.0);
is-approx($r3, 8555.8858472734, :abs-tol<1.0>); #delta_within($r3, 8555.8858472734, 1.0);
is-approx($r4, 45175077.2736035, :abs-tol<1.0>); #delta_within($r4, 45175077.2736035, 1.0);
is-approx($r5, 7434.86152969458, :abs-tol<1.0>); #delta_within($r5, 7434.86152969458, 1.0);
...
is-approx($r1, 17989959.0909754, :abs-tol<1.0>); #delta_within($r1, 17989959.0909754, 1.0);
is-approx($r2, 17989.9590909754, :abs-tol<1.0>); #delta_within($r2, 17989.9590909754, 1.0);
is-approx($r3, 11178.4423286603, :abs-tol<1.0>); #delta_within($r3, 11178.4423286603, 1.0);
is-approx($r4, 59022175.4953263, :abs-tol<1.0>); #delta_within($r4, 59022175.4953263, 1.0);
is-approx($r5, 9713.80080506233, :abs-tol<1.0>); #delta_within($r5, 9713.80080506233, 1.0);
...
is-approx($r1, 6743615.83724109, :abs-tol<1.0>); #delta_within($r1, 6743615.83724109, 1.0);
is-approx($r2, 6743.61583724109, :abs-tol<1.0>); #delta_within($r2, 6743.61583724109, 1.0);
is-approx($r3, 4190.28861277706, :abs-tol<1.0>); #delta_within($r3, 4190.28861277706, 1.0);
is-approx($r4, 22124723.8754629, :abs-tol<1.0>); #delta_within($r4, 22124723.8754629, 1.0);
is-approx($r5, 3641.26125121009, :abs-tol<1.0>); #delta_within($r5, 3641.26125121009, 1.0);
...
is-approx($r1, 14709618.4240825, :abs-tol<1.0>); #delta_within($r1, 14709618.4240825, 1.0);
is-approx($r2, 14709.6184240825, :abs-tol<1.0>); #delta_within($r2, 14709.6184240825, 1.0);
is-approx($r3, 9140.13313752838, :abs-tol<1.0>); #delta_within($r3, 9140.13313752838, 1.0);
is-approx($r4, 48259902.9661499, :abs-tol<1.0>); #delta_within($r4, 48259902.9661499, 1.0);
is-approx($r5, 7942.55854432099, :abs-tol<1.0>); #delta_within($r5, 7942.55854432099, 1.0);
...
is-approx($r1, 10036719.5388652, :abs-tol<1.0>); #delta_within($r1, 10036719.5388652, 1.0);
is-approx($r2, 10036.7195388652, :abs-tol<1.0>); #delta_within($r2, 10036.7195388652, 1.0);
is-approx($r3, 6236.52838601642, :abs-tol<1.0>); #delta_within($r3, 6236.52838601642, 1.0);
is-approx($r4, 32928869.8781667, :abs-tol<1.0>); #delta_within($r4, 32928869.8781667, 1.0);
is-approx($r5, 5419.39499938726, :abs-tol<1.0>); #delta_within($r5, 5419.39499938726, 1.0);
...
is-approx($r1, 13260281.1799076, :abs-tol<1.0>); #delta_within($r1, 13260281.1799076, 1.0);
is-approx($r2, 13260.2811799076, :abs-tol<1.0>); #delta_within($r2, 13260.2811799076, 1.0);
is-approx($r3, 8239.55672616147, :abs-tol<1.0>); #delta_within($r3, 8239.55672616147, 1.0);
is-approx($r4, 43504859.5141326, :abs-tol<1.0>); #delta_within($r4, 43504859.5141326, 1.0);
is-approx($r5, 7159.979038827, :abs-tol<1.0>); #delta_within($r5, 7159.979038827, 1.0);
...
is-approx($r1, 13454859.3055112, :abs-tol<1.0>); #delta_within($r1, 13454859.3055112, 1.0);
is-approx($r2, 13454.8593055112, :abs-tol<1.0>); #delta_within($r2, 13454.8593055112, 1.0);
is-approx($r3, 8360.46196805106, :abs-tol<1.0>); #delta_within($r3, 8360.46196805106, 1.0);
is-approx($r4, 44143239.1913096, :abs-tol<1.0>); #delta_within($r4, 44143239.1913096, 1.0);
is-approx($r5, 7265.04282155031, :abs-tol<1.0>); #delta_within($r5, 7265.04282155031, 1.0);
...
is-approx($r1, 7745665.22175974, :abs-tol<1.0>); #delta_within($r1, 7745665.22175974, 1.0);
is-approx($r2, 7745.66522175974, :abs-tol<1.0>); #delta_within($r2, 7745.66522175974, 1.0);
is-approx($r3, 4812.9332335161, :abs-tol<1.0>); #delta_within($r3, 4812.9332335161, 1.0);
is-approx($r4, 25412287.472965, :abs-tol<1.0>); #delta_within($r4, 25412287.472965, 1.0);
is-approx($r5, 4182.32463377956, :abs-tol<1.0>); #delta_within($r5, 4182.32463377956, 1.0);
...
is-approx($r1, 6929926.85789333, :abs-tol<1.0>); #delta_within($r1, 6929926.85789333, 1.0);
is-approx($r2, 6929.92685789333, :abs-tol<1.0>); #delta_within($r2, 6929.92685789333, 1.0);
is-approx($r3, 4306.0569138067, :abs-tol<1.0>); #delta_within($r3, 4306.0569138067, 1.0);
is-approx($r4, 22735980.5048994, :abs-tol<1.0>); #delta_within($r4, 22735980.5048994, 1.0);
is-approx($r5, 3741.86115437005, :abs-tol<1.0>); #delta_within($r5, 3741.86115437005, 1.0);
...
is-approx($r1, 5790460.28705559, :abs-tol<1.0>); #delta_within($r1, 5790460.28705559, 1.0);
is-approx($r2, 5790.46028705559, :abs-tol<1.0>); #delta_within($r2, 5790.46028705559, 1.0);
is-approx($r3, 3598.02521217067, :abs-tol<1.0>); #delta_within($r3, 3598.02521217067, 1.0);
is-approx($r4, 18997573.1202611, :abs-tol<1.0>); #delta_within($r4, 18997573.1202611, 1.0);
is-approx($r5, 3126.59842713585, :abs-tol<1.0>); #delta_within($r5, 3126.59842713585, 1.0);
...
is-approx($r1, 10404674.0369978, :abs-tol<1.0>); #delta_within($r1, 10404674.0369978, 1.0);
is-approx($r2, 10404.6740369978, :abs-tol<1.0>); #delta_within($r2, 10404.6740369978, 1.0);
is-approx($r3, 6465.16471121013, :abs-tol<1.0>); #delta_within($r3, 6465.16471121013, 1.0);
is-approx($r4, 34136069.6751895, :abs-tol<1.0>); #delta_within($r4, 34136069.6751895, 1.0);
is-approx($r5, 5618.07453401607, :abs-tol<1.0>); #delta_within($r5, 5618.07453401607, 1.0);
...
is-approx($r1, 1377371.39603648, :abs-tol<1.0>); #delta_within($r1, 1377371.39603648, 1.0);
is-approx($r2, 1377.37139603649, :abs-tol<1.0>); #delta_within($r2, 1377.37139603649, 1.0);
is-approx($r3, 855.858906508792, :abs-tol<1.0>); #delta_within($r3, 855.858906508792, 1.0);
is-approx($r4, 4518935.02636642, :abs-tol<1.0>); #delta_within($r4, 4518935.02636642, 1.0);
is-approx($r5, 743.721056175208, :abs-tol<1.0>); #delta_within($r5, 743.721056175208, 1.0);
...
is-approx($r1, 8357066.17548392, :abs-tol<1.0>); #delta_within($r1, 8357066.17548392, 1.0);
is-approx($r2, 8357.06617548392, :abs-tol<1.0>); #delta_within($r2, 8357.06617548392, 1.0);
is-approx($r3, 5192.84017306674, :abs-tol<1.0>); #delta_within($r3, 5192.84017306674, 1.0);
is-approx($r4, 27418196.1137924, :abs-tol<1.0>); #delta_within($r4, 27418196.1137924, 1.0);
is-approx($r5, 4512.45473838225, :abs-tol<1.0>); #delta_within($r5, 4512.45473838225, 1.0);
...
is-approx($r1, 11219022.8120392, :abs-tol<1.0>); #delta_within($r1, 11219022.8120392, 1.0);
is-approx($r2, 11219.0228120392, :abs-tol<1.0>); #delta_within($r2, 11219.0228120392, 1.0);
is-approx($r3, 6971.17758045464, :abs-tol<1.0>); #delta_within($r3, 6971.17758045464, 1.0);
is-approx($r4, 36807817.6248005, :abs-tol<1.0>); #delta_within($r4, 36807817.6248005, 1.0);
is-approx($r5, 6057.78769548552, :abs-tol<1.0>); #delta_within($r5, 6057.78769548552, 1.0);
...
is-approx($r1, 6560175.49592739, :abs-tol<1.0>); #delta_within($r1, 6560175.49592739, 1.0);
is-approx($r2, 6560.17549592739, :abs-tol<1.0>); #delta_within($r2, 6560.17549592739, 1.0);
is-approx($r3, 4076.30406919055, :abs-tol<1.0>); #delta_within($r3, 4076.30406919055, 1.0);
is-approx($r4, 21522885.4853261, :abs-tol<1.0>); #delta_within($r4, 21522885.4853261, 1.0);
is-approx($r5, 3542.21139088952, :abs-tol<1.0>); #delta_within($r5, 3542.21139088952, 1.0);
...
is-approx($r1, 4980459.53607217, :abs-tol<1.0>); #delta_within($r1, 4980459.53607217, 1.0);
is-approx($r2, 4980.45953607217, :abs-tol<1.0>); #delta_within($r2, 4980.45953607217, 1.0);
is-approx($r3, 3094.71407981897, :abs-tol<1.0>); #delta_within($r3, 3094.71407981897, 1.0);
is-approx($r4, 16340090.3414441, :abs-tol<1.0>); #delta_within($r4, 16340090.3414441, 1.0);
is-approx($r5, 2689.23301083811, :abs-tol<1.0>); #delta_within($r5, 2689.23301083811, 1.0);
...
is-approx($r1, 8467114.65823862, :abs-tol<1.0>); #delta_within($r1, 8467114.65823862, 1.0);
is-approx($r2, 8467.11465823862, :abs-tol<1.0>); #delta_within($r2, 8467.11465823862, 1.0);
is-approx($r3, 5261.22112999994, :abs-tol<1.0>); #delta_within($r3, 5261.22112999994, 1.0);
is-approx($r4, 27779247.5663997, :abs-tol<1.0>); #delta_within($r4, 27779247.5663997, 1.0);
is-approx($r5, 4571.87616535563, :abs-tol<1.0>); #delta_within($r5, 4571.87616535563, 1.0);
...
is-approx($r1, 17814444.0832232, :abs-tol<1.0>); #delta_within($r1, 17814444.0832232, 1.0);
is-approx($r2, 17814.4440832232, :abs-tol<1.0>); #delta_within($r2, 17814.4440832232, 1.0);
is-approx($r3, 11069.3823590377, :abs-tol<1.0>); #delta_within($r3, 11069.3823590377, 1.0);
is-approx($r4, 58446338.8557192, :abs-tol<1.0>); #delta_within($r4, 58446338.8557192, 1.0);
is-approx($r5, 9619.03028251793, :abs-tol<1.0>); #delta_within($r5, 9619.03028251793, 1.0);
...
is-approx($r1, 11323314.1064423, :abs-tol<1.0>); #delta_within($r1, 11323314.1064423, 1.0);
is-approx($r2, 11323.3141064423, :abs-tol<1.0>); #delta_within($r2, 11323.3141064423, 1.0);
is-approx($r3, 7035.98118639788, :abs-tol<1.0>); #delta_within($r3, 7035.98118639788, 1.0);
is-approx($r4, 37149980.6641808, :abs-tol<1.0>); #delta_within($r4, 37149980.6641808, 1.0);
is-approx($r5, 6114.10048943969, :abs-tol<1.0>); #delta_within($r5, 6114.10048943969, 1.0);
...
is-approx($r1, 16129090.5382028, :abs-tol<1.0>); #delta_within($r1, 16129090.5382028, 1.0);
is-approx($r2, 16129.0905382028, :abs-tol<1.0>); #delta_within($r2, 16129.0905382028, 1.0);
is-approx($r3, 10022.152217427, :abs-tol<1.0>); #delta_within($r3, 10022.152217427, 1.0);
is-approx($r4, 52916963.7080145, :abs-tol<1.0>); #delta_within($r4, 52916963.7080145, 1.0);
is-approx($r5, 8709.01216965595, :abs-tol<1.0>); #delta_within($r5, 8709.01216965595, 1.0);
...
is-approx($r1, 15535352.6980755, :abs-tol<1.0>); #delta_within($r1, 15535352.6980755, 1.0);
is-approx($r2, 15535.3526980755, :abs-tol<1.0>); #delta_within($r2, 15535.3526980755, 1.0);
is-approx($r3, 9653.22062783065, :abs-tol<1.0>); #delta_within($r3, 9653.22062783065, 1.0);
is-approx($r4, 50969004.9149458, :abs-tol<1.0>); #delta_within($r4, 50969004.9149458, 1.0);
is-approx($r5, 8388.41938341009, :abs-tol<1.0>); #delta_within($r5, 8388.41938341009, 1.0);
...
is-approx($r1, 14801887.1990009, :abs-tol<1.0>); #delta_within($r1, 14801887.1990009, 1.0);
is-approx($r2, 14801.8871990009, :abs-tol<1.0>); #delta_within($r2, 14801.8871990009, 1.0);
is-approx($r3, 9197.46629620569, :abs-tol<1.0>); #delta_within($r3, 9197.46629620569, 1.0);
is-approx($r4, 48562622.0439661, :abs-tol<1.0>); #delta_within($r4, 48562622.0439661, 1.0);
is-approx($r5, 7992.3796970847, :abs-tol<1.0>); #delta_within($r5, 7992.3796970847, 1.0);
...
is-approx($r1, 8481627.39707062, :abs-tol<1.0>); #delta_within($r1, 8481627.39707062, 1.0);
is-approx($r2, 8481.62739707062, :abs-tol<1.0>); #delta_within($r2, 8481.62739707062, 1.0);
is-approx($r3, 5270.23892783061, :abs-tol<1.0>); #delta_within($r3, 5270.23892783061, 1.0);
is-approx($r4, 27826861.5389456, :abs-tol<1.0>); #delta_within($r4, 27826861.5389456, 1.0);
is-approx($r5, 4579.71241742474, :abs-tol<1.0>); #delta_within($r5, 4579.71241742474, 1.0);
...
is-approx($r1, 17356605.1087735, :abs-tol<1.0>); #delta_within($r1, 17356605.1087735, 1.0);
is-approx($r2, 17356.6051087735, :abs-tol<1.0>); #delta_within($r2, 17356.6051087735, 1.0);
is-approx($r3, 10784.8944096312, :abs-tol<1.0>); #delta_within($r3, 10784.8944096312, 1.0);
is-approx($r4, 56944242.4828528, :abs-tol<1.0>); #delta_within($r4, 56944242.4828528, 1.0);
is-approx($r5, 9371.81701337664, :abs-tol<1.0>); #delta_within($r5, 9371.81701337664, 1.0);
