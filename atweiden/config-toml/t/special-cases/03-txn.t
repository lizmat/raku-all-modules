...
subtest
{
    ...
    is(
        $match_toml.made<TXN>[0]<drift>,
        0,
        q:to/EOF/
        ♪ [Is expected value?] - 21 of 49
        ┏━━━━━━━━━━━━━┓
        ┃             ┃  ∙ $match_toml.made<TXN>[0]<drift> == 0
        ┃   Success   ┃
        ┃             ┃
        ┗━━━━━━━━━━━━━┛
        EOF
    ...
    is(
        $match_toml.made<TXN>[0]<entity>,
        'VarName',
        q:to/EOF/
        ♪ [Is expected value?] - 22 of 49
        ┏━━━━━━━━━━━━━┓
        ┃             ┃  ∙ $match_toml.made<TXN>[0]<entity> ~~ 'VarName'
        ┃   Success   ┃
        ┃             ┃
        ┗━━━━━━━━━━━━━┛
        EOF
    ...
    is(
        $match_toml.made<TXN>[0]<EntryID><number>,
        0,
        q:to/EOF/
        ♪ [Is expected value?] - 22 of 49
        ┏━━━━━━━━━━━━━┓
        ┃             ┃  ∙ $match_toml.made<TXN>[0]<EntryID><number> == 0
        ┃   Success   ┃
        ┃             ┃
        ┗━━━━━━━━━━━━━┛
        EOF
    ...
    is(
        $match_toml.made<TXN>[0]<EntryID><xxhash>,
        5555555,
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<EntryID><text>,
        'capture entry',
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<ModHoldings><AssetCode><entity>,
        'VarName',
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<ModHoldings><AssetCode><asset_code>,
        'AssetCode',
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<ModHoldings><AssetCode><asset_flow>,
        'AssetFlow',
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<ModHoldings><AssetCode><costing>,
        'Costing',
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<ModHoldings><AssetCode><date>,
        'DateTime',
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<ModHoldings><AssetCode><price>,
        5.55,
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<ModHoldings><AssetCode><acquisition_price_asset_code>,
        'AssetCode',
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<ModHoldings><AssetCode><quantity>,
        5.5555555,
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<ModWallet>[0]<silo>,
        'SILO',
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<ModWallet>[0]<entity>,
        'VarName',
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<ModWallet>[0]<subwallet>[0],
        'VarName',
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<ModWallet>[0]<asset_code>,
        'AssetCode',
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<ModWallet>[0]<decinc>,
        'DecInc',
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<ModWallet>[0]<quantity>,
        5.5555555,
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<ModWallet>[0]<xe_asset_code>,
        '',
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<ModWallet>[0]<xe_asset_quantity>,
        '',
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<ModWallet>[0]<EntryID><number>,
        0,
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<ModWallet>[0]<EntryID><xxhash>,
        5555555,
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<ModWallet>[0]<EntryID><text>,
        'capture entry',
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<ModWallet>[0]<PostingID><number>,
        0,
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<ModWallet>[0]<PostingID><xxhash>,
        55555557,
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<ModWallet>[0]<PostingID><text>,
        'capture posting',
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<ModWallet>[0]<PostingID><EntryID><number>,
        0,
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<ModWallet>[0]<PostingID><EntryID><xxhash>,
        5555555,
        q:to/EOF/
    ...
    is(
        $match_toml.made<TXN>[0]<ModWallet>[0]<PostingID><EntryID><text>,
        'capture entry',
        q:to/EOF/
