...
unit class DateTime::TimeZone::Zone::America::Blanc_minus_Sablon does DateTime::TimeZone::Zone;
has %.rules = ( 
...
has @.zonedata = [{:baseoffset("-3:48:28"), :rules(""), :until(-2713910400)}, {:baseoffset("-4:00"), :rules("Canada"), :until(0)}, {:baseoffset("-4:00"), :rules(""), :until(Inf)}]<>;
