...
unit class DateTime::TimeZone::Zone::America::Nipigon does DateTime::TimeZone::Zone;
has %.rules = ( 
...
has @.zonedata = [{:baseoffset("-5:53:04"), :rules(""), :until(-2366755200)}, {:baseoffset("-5:00"), :rules("Canada"), :until(-923270400)}, {:baseoffset("-4:00"), :rules(""), :until(-880236000)}, {:baseoffset("-5:00"), :rules("Canada"), :until(Inf)}]<>;
