...
my Blob $passphrase .= new: @passphrase;
my Blob $plaintext  .= new: @plaintext;
...
$passphrase .= new(0x01,0x23,0x45,0x67,0x89,0xab,0xcd,0xef);
$plaintext .= new(0x68,0x65,0x20,0x74,0x69,0x6d,0x65,0x20);
...
$passphrase .= new(0xef,0x01,0x23,0x45);
$plaintext .= new(0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00);
$encrypted = RC4( $passphrase, $plaintext );
$decrypted = RC4( $passphrase, $encrypted );
...

{
    ...
    my Crypt::RC4 $one .= new( :key($pass1));
    my Crypt::RC4 $two .= new( :key($pass2));
