...
unit class DateTime::TimeZone::Zone::America::Godthab does DateTime::TimeZone::Zone;
has %.rules = ( 
...
has @.zonedata = [{:baseoffset("-3:26:56"), :rules(""), :until(-1686096000)}, {:baseoffset("-3:00"), :rules(""), :until(323834400)}, {:baseoffset("-3:00"), :rules("EU"), :until(Inf)}]<>;
