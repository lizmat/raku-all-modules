...
unit class DateTime::TimeZone::Zone::Asia::Tashkent does DateTime::TimeZone::Zone;
has %.rules = ( 
...
has @.zonedata = [{:baseoffset("4:37:12"), :rules(""), :until(-1441152000)}, {:baseoffset("5:00"), :rules(""), :until(-1247529600)}, {:baseoffset("6:00"), :rules("RussiaAsia"), :until(670384800)}, {:baseoffset("5:00"), :rules("RussiaAsia"), :until(683683200)}, {:baseoffset("5:00"), :rules("RussiaAsia"), :until(694224000)}, {:baseoffset("5:00"), :rules(""), :until(Inf)}]<>;
