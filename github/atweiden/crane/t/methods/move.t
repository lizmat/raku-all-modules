...
subtest({
    ...
    my %h = :a({:b({:c({:d({:e(True)})})})});
    throws-like(
        { Crane.move(%h, :from(), :path('a',)) },
        X::Crane::MoveParentToChild,
        'Not allowed to move parent into child'
    );
    throws-like(
        { Crane.move(%h, :from(), :path('a', 'b')) },
        X::Crane::MoveParentToChild,
        'Not allowed to move parent into child'
    );
    throws-like(
        { Crane.move(%h, :from('a',), :path('a', 'b')) },
        X::Crane::MoveParentToChild,
        'Not allowed to move parent into child'
    );
    throws-like(
        { Crane.move(%h, :from('a',), :path('a', 'b', 'c')) },
        X::Crane::MoveParentToChild,
        'Not allowed to move parent into child'
    );
    throws-like(
        { Crane.move(%h, :from('a', 'b'), :path('a', 'b', 'c')) },
        X::Crane::MoveParentToChild,
        'Not allowed to move parent into child'
    );
    throws-like(
        { Crane.move(%h, :from('a', 'b'), :path('a', 'b', 'c', 'd')) },
        X::Crane::MoveParentToChild,
        'Not allowed to move parent into child'
    );
    throws-like(
        { Crane.move(%h, :from('a', 'b', 'c'), :path('a', 'b', 'c', 'd')) },
        X::Crane::MoveParentToChild,
        'Not allowed to move parent into child'
    );
    throws-like(
        { Crane.move(%h, :from('a', 'b', 'c'), :path('a', 'b', 'c', 'd', 'e')) },
        X::Crane::MoveParentToChild,
        'Not allowed to move parent into child'
    );
    ...
    throws-like(
        { Crane.move(%i, :from('a', *-0), :path('b',)) },
        X::Crane::MoveFromNotFound,
        'Move operation fails when from not found'
    );

    # X::Crane::MovePathNotFound
    throws-like(
        { Crane.move(%i, :from('a', 0), :path('foo', 'bar')) },
        X::Crane::MovePathNotFound,
        'Move operation fails when path not found'
    );

    # X::Crane::MoveFrom::RO
    my %j = :a(:pair(:is(:not(:a<hash>))));
    throws-like(
        { Crane.move(%j, :from(qw<a pair is not a>), :path('hash',)) },
        X::Crane::MoveFrom::RO,
        'Move operation fails when from is immutable'
    );
    ...
    throws-like(
        ...
        X::Crane::MovePath::RO,
        'Move operation fails when path is immutable'
    );

    # X::Crane::PositionalIndexInvalid
    throws-like(
        { Crane.move(%i, :from('a', 'b'), :path('b',)) },
        X::Crane::PositionalIndexInvalid,
    ...
    throws-like(
        { Crane.move(%doc, :from('a', 1), :path('a', *-20)) },
    ...
    throws-like(
        { Crane.move(%doc, :from('a', 1), :path('a', *+1)) },
        X::Crane::MovePathOutOfRange,
        :message(
            /'move operation failed, creating sparse Positional not allowed.'/
        ),
