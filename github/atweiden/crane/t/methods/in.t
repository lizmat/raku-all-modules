...
subtest({
    ...
    Crane.in(%h, 'h', 0, 'f') = 'Hasselhoff';
    is(%h<h>[0]<f>, 'Hasselhoff', 'Is expected value');

    Crane.in(%h, 'h', 0, 'f') = 'Not Hasselhoff';
    is(%h<h>[0]<f>, 'Not Hasselhoff', 'Is expected value');

    my %i;
    Crane.in(%i, qw<a b c>, *-0, *-0, *-0, *-0, *-0) = 'five';
    Crane.in(%i, qw<a b c>, *-0, *-0, *-0, *-0, *-0) = 'five again';
    ...
    Crane.in(%data, 'legumes', *-0) = %legume;
