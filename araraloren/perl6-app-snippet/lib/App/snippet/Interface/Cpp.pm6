...
unit class App::snippet::Interface::Cpp does App::snippet::Interface is export;
...
EOF
	...
	$!optset.append(
		'u|using=a' => 'add using declaration under macro definition.',
		'ns=a' => 'add using namespace declaration under macro definition.',
	);
    $!optset.set-value('i', 'iostream');
	$!optset;
}
