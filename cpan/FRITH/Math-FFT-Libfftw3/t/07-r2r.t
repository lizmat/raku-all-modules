...
subtest {
  ...
  isa-ok $fft.in, 'List', 'internal input array - Real';
  is-deeply $fft.in, (1e0, 2e0, 3e0, 4e0, 5e0, 6e0), 'input array';
...
subtest {
  ...
  {
    my @data = 1..6;
    my Math::FFT::Libfftw3::R2R $fft .= new: data => @data, kind => FFTW_R2HC;
  ...
  {
    my Math::FFT::Libfftw3::R2R $fft .= new: data => (1/1, 2/1 … 6/1), kind => FFTW_R2HC;
    is-deeply $fft.in, (1e0, 2e0, 3e0, 4e0, 5e0, 6e0), 'Sequence of Rat';
  }
  {
    my Math::FFT::Libfftw3::R2R $fft .= new: data => (1/1, 2/1, 3/1, 4/1, 5/1, 6/1), kind => FFTW_R2HC;
  ...
  {
    my Math::FFT::Libfftw3::R2R $fft .= new: data => (1e0, 2e0 … 6e0), kind => FFTW_R2HC;
  ...
  {
    my Math::FFT::Libfftw3::R2R $fft .= new: data => (<1>, <2>, <3>, <4>, <5>, <6>), kind => FFTW_R2HC;
  ...
  {
    my Math::FFT::Libfftw3::R2R $fft .= new: data => (<1e0>, <2e0>, <3e0>, <4e0>, <5e0>, <6e0>), kind => FFTW_R2HC;
