...
Read more in L<OO::Plugin::Manual|https://github.com/vrurg/Perl6-OO-Plugin/blob/v0.0.905/docs/md/OO/Plugin/Manual.md>.
...
module OO::Plugin:ver<0.0.905>:auth<github:vrurg> {
