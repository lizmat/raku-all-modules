...
class PDF::Group::Transparency
    ...
    has NameOrArray $.CS is entry; #| (Sometimes required) The group colour space, which is used for the following purposes:
    ...
    has Bool $.I is entry; #| (Optional) A flag specifying whether the transparency group is isolated
    has Bool $.K is entry; #| (Optional) A flag specifying whether the transparency group is a knockout group
}
