...
class PDF::Annot::Text
    ...
    has PDF::DAO::TextString $.StateModel is entry;  #| (Required if State is present, otherwise optional; PDF 1.5) The state model corresponding to State; see “Annotation States,” above
