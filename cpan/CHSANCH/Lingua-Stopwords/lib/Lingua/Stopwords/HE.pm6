...
sub get-list ( Str $list is copy = 'ranks-nl' --> SetHash ) is export {
    
    my SetHash $stop-words .= new;
   
    $stop-words = <  א אביב אבל אגב אדם אהבה או אוהב אוהבים אוהבת אוכל אולי אומר אופן אופנה אותה אותו אותי אותך אותם אז 
                    ...
                    תחרות תמונה תמונות תמיד תפוז תשובות ‡ >.SetHash;
