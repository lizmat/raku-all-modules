...
use StrictClass;
unit class Net::BGP::Message::Notify::Header:ver<0.0.9>:auth<cpan:JMASLAK>
...
# Register handler
INIT { Net::BGP::Message::Notify.register(Net::BGP::Message::Notify::Header) }

=begin pod

=head1 NAME

Net::BGP::Message::Notify::Header - Header BGP Notify Message
...
Header Notify BGP message type
