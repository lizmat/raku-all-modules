...
use StrictClass;
unit class Net::BGP::Message::Notify::Header::Generic:ver<0.0.8>:auth<cpan:JMASLAK>
...
# Register handler
INIT { Net::BGP::Message::Notify::Header.register(Net::BGP::Message::Notify::Header::Generic) }

=begin pod

=head1 NAME

Net::BGP::Message::Notify::Header::Generic - Generic Header Error BGP Notify Message
...
Generic Header error BGP Notify message type
