...
class DateTime::TimeZone::Zone::Europe::Andorra does DateTime::TimeZone::Zone;
has %.rules = ( 
...
has @.zonedata = Array.new({"baseoffset" => "0:06:04", "rules" => "", "until" => -2177452800}, {"baseoffset" => "0:00", "rules" => "", "until" => -733881600}, {"baseoffset" => "1:00", "rules" => "", "until" => 481082400}, {"baseoffset" => "1:00", "rules" => "EU", "until" => Inf});
