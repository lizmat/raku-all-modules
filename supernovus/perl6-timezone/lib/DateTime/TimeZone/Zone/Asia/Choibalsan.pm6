...
class DateTime::TimeZone::Zone::Asia::Choibalsan does DateTime::TimeZone::Zone;
has %.rules = ( 
...
has @.zonedata = Array.new({"baseoffset" => "7:38:00", "rules" => "", "until" => -2051222400}, {"baseoffset" => "7:00", "rules" => "", "until" => 252460800}, {"baseoffset" => "8:00", "rules" => "", "until" => 410227200}, {"baseoffset" => "9:00", "rules" => "Mongol", "until" => 1206921600}, {"baseoffset" => "8:00", "rules" => "Mongol", "until" => Inf});
