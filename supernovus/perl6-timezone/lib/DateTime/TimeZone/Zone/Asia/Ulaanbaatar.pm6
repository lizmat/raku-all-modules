...
class DateTime::TimeZone::Zone::Asia::Ulaanbaatar does DateTime::TimeZone::Zone;
has %.rules = ( 
...
has @.zonedata = Array.new({"baseoffset" => "7:07:32", "rules" => "", "until" => -2051222400}, {"baseoffset" => "7:00", "rules" => "", "until" => 252460800}, {"baseoffset" => "8:00", "rules" => "Mongol", "until" => Inf});
