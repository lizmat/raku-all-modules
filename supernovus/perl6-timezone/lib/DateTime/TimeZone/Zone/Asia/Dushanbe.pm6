...
unit class DateTime::TimeZone::Zone::Asia::Dushanbe does DateTime::TimeZone::Zone;
has %.rules = ( 
...
has @.zonedata = [{:baseoffset("4:35:12"), :rules(""), :until(-1441152000)}, {:baseoffset("5:00"), :rules(""), :until(-1247529600)}, {:baseoffset("6:00"), :rules("RussiaAsia"), :until(670384800)}, {:baseoffset("6:00"), :rules(""), :until(684381600)}, {:baseoffset("5:00"), :rules(""), :until(Inf)}]<>;
