...
class DateTime::TimeZone::Zone::Asia::Chongqing does DateTime::TimeZone::Zone;
has %.rules = ( 
...
has @.zonedata = Array.new({"baseoffset" => "7:06:20", "rules" => "", "until" => -1325462400}, {"baseoffset" => "7:00", "rules" => "", "until" => 315532800}, {"baseoffset" => "8:00", "rules" => "PRC", "until" => Inf});
