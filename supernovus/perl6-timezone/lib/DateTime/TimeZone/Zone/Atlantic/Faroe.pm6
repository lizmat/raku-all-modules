...
class DateTime::TimeZone::Zone::Atlantic::Faroe does DateTime::TimeZone::Zone;
has %.rules = ( 
...
has @.zonedata = Array.new({"baseoffset" => "-0:27:04", "rules" => "", "until" => -1955750400}, {"baseoffset" => "0:00", "rules" => "", "until" => 347155200}, {"baseoffset" => "0:00", "rules" => "EU", "until" => Inf});
