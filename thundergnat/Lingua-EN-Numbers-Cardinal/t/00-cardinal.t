...
is(cardinal(15/1000, denominator => 1000), 'fifteen thousandths', 'Rat common');
is(cardinal(15/1000, :denominator(1000)), 'fifteen thousandths', 'Rat common');
is(cardinal(20/1000, :den(1000)), 'twenty thousandths', 'Rat common');
is(cardinal(27/16, :denominator(32), :improper), 'fifty-four thirty-seconds', 'Rat common improper');
...
is(cardinal(15/4, :im), 'fifteen quarters', 'Rat improper');
...
is(cardinal(97873/10000000, separator => '/'),
  'ninety-seven thousand, eight hundred seventy-three/ten millionths', 'Rat separator');
is(cardinal(17/57, sep => '/'), 'seventeen/fifty-sevenths', 'Rat separator');
...
is(cardinal('-35/12', :denominator(24) ), 'negative two and twenty-two twenty-fourths', 'String common');
is(cardinal('-35/12', :denominator(24), :improper), 'negative seventy twenty-fourths', 'String common improper');

is(cardinal(2.5e-2), 'two point five times ten to the negative second', 'Num');
is(cardinal(2.5e+2), 'two point five times ten to the second', 'Num');
is(cardinal(-2.5e+2), 'negative two point five times ten to the second', 'Num');
is(cardinal(1/1.0e4), 'one times ten to the negative fourth', 'Num');
is(cardinal(0e0), 'zero times ten to the zeroth', 'Num');
...
dies-ok({ cardinal(1e309) }, 'Dies on overflow');
