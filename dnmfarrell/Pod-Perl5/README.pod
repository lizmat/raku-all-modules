...
The parser can parse inline pod and standalone F<*.pod> files and supports all pod syntax. It also comes with
a pod-to-html action class for the grammar C<Pod::Perl5::ToHTML>.
