...
is_approx expm1(0), 0, "expm1(0) == 0";
is_approx expm1(1e-50), 1e-50, "expm1(1e-50) == 1e-50";
is_approx expm1(-1e-50), -1e-50, "expm1(-1e-50) == -1e-50";
is_approx expm1(.5), 0.6487212707, "expm1(.5) == 0.6487212707";
is_approx expm1(-.5), -0.3934693403, "expm1(-.5) == -0.3934693403";
is_approx expm1(1), 1.718281828, "expm1(1) == 1.718281828";
is_approx expm1(10), 22025.46579, "expm1(10) == 22025.46579";
is_approx expm1(100), 2.688117142e+43, "expm1(100) == 2.688117142e+43";
